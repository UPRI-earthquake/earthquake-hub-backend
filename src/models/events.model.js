 ...
 *             type: string
 *             readOnly: true
 *             description: Canonical summary generated by the backend from the event record.
 *           effectiveSummary:
 *             type: string
 *             readOnly: true
 *             description: Public summary selected by the publication policy.
 *           eventSummary:
 *             type: string
 *             readOnly: true
 *             deprecated: true
 *             description: Backward-compatible alias of effectiveSummary.
 *           summaryPublication:
 *             type: object
 *             readOnly: true
 *             properties:
 *               policy:
 *                 type: string
 *                 enum: [approved_only, compatibility]
 *               source:
 *                 type: string
 *                 enum: [generated, approved_custom, compatibility_custom]
 *               generatorVersion:
 *                 type: string
 *               compatibilityMode:
 *                 type: boolean
 ...
 *             nullable: true
 *             description: >
 *               Full review metadata is available only to authorized admin APIs.
 *               Public APIs include this object only when its custom text is the
 *               selected public summary, and omit editor identity and timestamps.
 *             properties:
 *               text:
 *                 type: string
 *                 description: User-edited summary text. It becomes public only after approval unless temporary compatibility mode is enabled.
 *               editedAt:
 *                 type: string
 *                 format: date-time
 ...
 *               reviewStatus:
 *                 type: string
 *                 enum: [draft, needs_review, approved]
 *                 description: Administrative review state. Existing summaries without this field are treated as draft.
...
const summaryOverrideSchema = new mongoose.Schema(
  {
    ...
    reviewStatus:          { type: String, enum: ['draft', 'needs_review', 'approved'], default: 'draft' },
    reviewStatusChangedAt: { type: Date, default: Date.now },
    reviewStatusChangedBy: { type: String },
    submittedAt:           Date,
    submittedBy:           String,
    approvedAt:            Date,
    approvedBy:            String,
